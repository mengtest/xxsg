...
public interface IFightSide { void initGuid(byte paramByte);
    void getGroupData(List<FightGroupData> paramList); void getCandidateFighterData(List<FightGroupData> paramList);
