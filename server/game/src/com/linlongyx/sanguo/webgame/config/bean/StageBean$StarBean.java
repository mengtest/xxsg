...
/*    */   
/*    */   public String toString() {
/* 87 */     String retVal = "skillID= " + this.skillID + ", card= " + this.card + ", attr= " + this.attr + ", levelPar= " + this.levelPar;
/* 88 */     return retVal;
/*    */   }
/*    */ }


/* Location:              D:\xxsg_52gmsy\game\target\classes\!\com\linlongyx\sanguo\webgame\config\bean\StageBean$StarBean.class
