...
/* 23 */     this.eventResponseId = 21107;
/* 24 */     this.codeType = 2;
/*    */   }
/*    */   
/*    */   public GroupMemberListResponse(short retCode) {
/* 28 */     this.eventResponseId = 21107;
/* 29 */     this.codeType = 2;
...
/*    */       
/* 40 */       GroupMemberData tmp_0 = this.datas.get(index_0);
/* 41 */       tmp_0.serial(out);
/*    */     } 
/*    */   }
/*    */ 
...
/*    */       
/* 51 */       GroupMemberData tmp_0 = new GroupMemberData();
...
/*    */ 
/*    */   
/*    */   public GroupMemberListResponse clone() throws CloneNotSupportedException {
/* 59 */     GroupMemberListResponse clone = (GroupMemberListResponse)super.clone();
/* 60 */     int size_0 = this.datas.size();
/* 61 */     for (int index_0 = 0; index_0 < size_0; index_0++) {
/*    */       
/* 63 */       GroupMemberData tmp_0 = this.datas.get(index_0);
...
/* Location:              D:\xxsg_52gmsy\game\target\classes\!\com\linlongyx\sanguo\webgame\proto\binary\group\GroupMemberListResponse.class
