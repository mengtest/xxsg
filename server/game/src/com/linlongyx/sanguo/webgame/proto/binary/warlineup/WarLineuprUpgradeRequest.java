...
/*    */ 
/*    */ @Message
/*    */ public class WarLineuprUpgradeRequest
/*    */   extends RequestBase
/*    */ {
...
/*    */ 
/*    */   
/*    */   public WarLineuprUpgradeRequest() {
/* 25 */     this.eventRequestId = 16505;
/* 26 */     this.codeType = 2;
/*    */   }
/*    */ 
/*    */   
/*    */   public void serial(ByteBuf out) {
/* 31 */     ProtocolUtil.writeInt(out, this.warlineup);
/*    */     
...
/* 52 */     this.warlineup = ProtocolUtil.readUTFBinInt(in);
/*    */     
...
/*    */ 
/*    */   
/*    */   public WarLineuprUpgradeRequest clone() throws CloneNotSupportedException {
/* 71 */     WarLineuprUpgradeRequest clone = (WarLineuprUpgradeRequest)super.clone();
...
/* 96 */     String retVal = "{\"warlineup\":" + this.warlineup + ",\"itemId\":" + this.itemId.toString() + ",\"ItemNum\":" + this.ItemNum.toString() + "}";
/* 97 */     return retVal;
/*    */   }
/*    */ }


/* Location:              D:\xxsg_52gmsy\game\target\classes\!\com\linlongyx\sanguo\webgame\proto\binary\warlineup\WarLineuprUpgradeRequest.class
