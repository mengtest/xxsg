...
/*     */ import com.linlongyx.sanguo.webgame.config.bean.AttrNameBean;
...
/*     */   public static final byte ALIENRACE_FIGHT = 15;
/*     */   public static final byte CROSS_RACE_FIGHT = 16;
/*     */   public static final byte YEAR_BEAST_FIGHT = 17;
/*     */   public static final byte TOWER_OWNER_FIGHT = 18;
/*     */   public static final byte SECRETI_FIGHT = 19;
/*     */   public static final byte RUNE_WAR_FIGHT = 20;
...
/* 103 */   byte SKILL_INDEX_1 = 1;
/* 104 */   byte SKILL_INDEX_2 = 2;
/*     */   
...
/* 187 */   public static final Set<Integer> SEAL_BUFF_TYPE = new HashSet<>(Collections.singletonList(Integer.valueOf(BuffType.DIZZY.getType())));
/*     */   
/* 189 */   public static final Set<Integer> SILENT_BUFF_TYPE = new HashSet<>(Arrays.asList(new Integer[] { Integer.valueOf(BuffType.SILENT.getType()), Integer.valueOf(BuffType.DISORDER.getType()) }));
/*     */   
/* 191 */   private static final FightParameter fightParamter = (FightParameter)ParameterConstant.getParameter(1);
/*     */ 
/*     */   
/*     */   public static double getHitBaseValue() {
/* 195 */     return fightParamter.getHitBaseValue();
/*     */   }
/*     */   
/*     */   public static double getCritBaseValue() {
/* 199 */     return fightParamter.getCritBaseValue();
/*     */   }
/*     */   
/*     */   public static double getCritHurtBaseValue() {
/* 203 */     return fightParamter.getCritHurtBaseValue();
/*     */   }
/*     */   
/*     */   public static double getHitRange() {
/* 207 */     return fightParamter.getHitRange();
/*     */   }
/*     */   
/*     */   public static double getCriticalRange() {
/* 211 */     return fightParamter.getCriticalRange();
/*     */   }
/*     */   
/*     */   public static double getMinHurtRate() {
/* 215 */     return fightParamter.getMinHurtRate();
/*     */   }
/*     */   
/*     */   public static double getMinDogeRate() {
/* 219 */     return fightParamter.getMinDogeRate();
/*     */   }
/*     */   
/* 222 */   private static long[] weights = new long[AttributeType.ATTRIB_TYPE_END.getType()];
/*     */   
...
/* 230 */     for (int i = 1; i < weights.length; i++) {
/* 231 */       AttrNameBean attrNameBean = (AttrNameBean)JsonTableService.getJsonData(i, AttrNameBean.class);
/* 232 */       if (null != attrNameBean) {
/* 233 */         weights[attrNameBean.getId()] = attrNameBean.getPower();
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/* 252 */     if (type >= weights.length)
/* 253 */       return 0L; 
/* 254 */     return weights[type];
/*     */   }
/*     */ }


/* Location:              D:\xxsg_52gmsy\game\target\classes\!\com\linlongyx\sanguo\webgame\common\fight\FightConstant.class
