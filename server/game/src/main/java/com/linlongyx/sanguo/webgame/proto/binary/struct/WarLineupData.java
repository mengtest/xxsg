...
/* 20 */     ProtocolUtil.writeInt(out, this.warLineup);
...
/* 30 */     this.warLineup = ProtocolUtil.readUTFBinInt(in);
...
/*    */ 
/*    */   
/*    */   public WarLineupData clone() throws CloneNotSupportedException {
/* 40 */     WarLineupData clone = (WarLineupData)super.clone();
/* 41 */     return clone;
/*    */   }
/*    */ 
/*    */   
...
/* 56 */     String retVal = "{\"warLineup\":" + this.warLineup + ",\"star\":" + this.star + ",\"level\":" + this.level + ",\"battle\":" + this.battle + ",\"exp\":" + this.exp + ",\"fightValue\":" + this.fightValue + "}";
/* 57 */     return retVal;
/*    */   }
/*    */ }


/* Location:              D:\xxsg_52gmsy\game\target\classes\!\com\linlongyx\sanguo\webgame\proto\binary\struct\WarLineupData.class
