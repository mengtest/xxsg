...
/*    */ 
/*    */ 
/*    */ public class RankingGenStar2
/*    */   extends AbstractRank
/*    */ {
/*    */   public void initRanksMySql() {
/* 14 */     this.ranks.clear();
/* 15 */     this.playerIdRankMap.clear();
/* 16 */     String selectSql = "SELECT distinct p.playerId,p.playerName,p.level,p.totalValue,p.head,p.sex,p.vip,p.wearTitle,p.wearFashion,p.quality, g.difficultyStar FROM tb_player p, tb_general g  WHERE p.playerId = g.playerId and g.difficultyStar > 0 ORDER BY g.difficultyStar DESC, p.totalValue DESC LIMIT " + this.rankSize;
/*    */     
...
/* 31 */       int difficultyStar = ((Integer)map.get("difficultyStar")).intValue();
...
/* 38 */         this.ranks.add(RankingUtil.transform(playerId.longValue(), playerName, fightValue, level, head, vip, sex, wearTitle, wearFashion, quality, difficultyStar, rank++)); 
/*    */     } 
/*    */   }
/*    */ }


/* Location:              D:\xxsg_52gmsy\game\target\classes\!\com\linlongyx\sanguo\webgame\service\rank\RankingGenStar2.class
